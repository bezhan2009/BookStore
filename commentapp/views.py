...
class CommentList(APIView):
    ...
    def get_object(self, book_id):
        try:
            ...
            logger.warning(f"Failed to get comments. Book not found.")
            raise Response({"message": "Book not found"}, status=404)
    ...
    def get(self, request, book_id):
        try:
            main_comments, comments_dict = self.get_object(book_id)
        ...
        try:
            ...
            if serializer.is_valid():
                ...
                if parent_comment_id:
                    ...
                    serializer.save(user=user_profile, book=book)
